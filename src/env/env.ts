...
const rawEnvVariables = [
  ...
  {
    name: "AUTHOR",
    value: import.meta.env.VITE_AUTHOR,
  },
  {
    name: "APP_NAME",
  ...
  {
    name: "PROJECT_HREF",
    value: import.meta.env.VITE_PROJECT_HREF,
  },
] as const
...
const ENV = {
  ...
  AUTHOR: validatedEnvVariables.AUTHOR,
  APP_NAME: validatedEnvVariables.APP_NAME,
  PROJECT_HREF: validatedEnvVariables.PROJECT_HREF,
}
